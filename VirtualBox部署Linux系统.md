...
![1537669949731](img\1537669949731.png)

### 七.在打开的软件界面中,进行全局设置

![1537670237795](img\1537670237795.png)

### 八.在全局设置中的常规中,更改安装虚拟机安装的路径

![1537670492726](img\1537670492726.png)

### 九.在热键中,更改虚拟机切除热键(跟据个人习惯自由设定)

![1537670772614](img\1537670772614.png)
...
​	针对安装的不同的Virtualbox版本,应安装与之对应的`vbox-extpack`扩展包
   ...
   -  查看VirtualBox版本
     ...
     ![1537672059198](img\1537672059198.png)

     ![1537672133448](img\1537672133448.png)

   - 在官网下载对应的版本

     ![1537672315743](img\1537672315743.png)

     > ​	安装地址 : [https://www.virtualbox.org/wiki/Downloads]()

   - 在扩展中进行安装

     ![1537672447518](img\1537672447518.png)

     ![1537672535428](img\1537672535428.png)

     ![1537672577278](img\1537672577278.png)

     ![1537672691704](img\1537672691704.png)

     ![1537672752202](img\1537672752202.png)
...
![1537677867170](img\1537677867170.png)
...
![1537680500517](img\1537680500517.png)

![1537680660517](img\1537680660517.png)

![1537680711259](img\1537680711259.png)

![1537680793503](img\1537680793503.png)

> ​	虚拟硬盘可以分配大一些 ，之前的设置中可以动态调整硬盘的内容。

![1537681016845](img\1537681016845.png)

### 五.Linux安装前的设置

- ​	设置系统属性

![1537681161634](img\1537681161634.png)

- ​	设置处理器个数

![1537681334669](img\1537681278277.png)

> ​	在系统的处理中,可以针对自己的电脑选择处理器的个数,这里分配1个处理器

- ​	设置内存

  ![1537681611010](img\1537681611010.png)

	 ​	由于此次将安装Centos桌面版,显存可以设置32MB以上,这里设置为32MB

	 ​	设置安装镜像位置

![1537681952369](img\1537681952369.png)

![1537682287958](img\1537682287958.png)

- ​	设置网络(重点)

![1537682491509](img\1537682491509.png)

> ​	上图的这是的作用可以让虚拟机可以连接上互联网(要保证主机能够上网)



![1537842638431](img\1537842638431.png)
...
![1537683190386](img\1537683190386.png)

![1537683466039](img\1537683466039.png)

​                                	![1537683722941](img\153768351601.png)

- ​	进入的Centos的安装步骤

![1537683388391](img\1537683388391.png)

- ​	选择Skip，跳过media测试 

![1537684335763](img\1537684335763.png)

- ​	开始Centos的安装

![1537684406772](img\1537684406772.png)

- ​	语种的选择(生成环境尽量采用英文版,避免软件对中文的不兼容)

![1537684479890](img\1537684479890.png)

- ​	键盘选择默认的就可以了(美式键盘)

![1537684610562](img\1537684610562.png)

- ​	选择基本存储设备(选择默认)

  ![1537684776626](img\1537684776626.png)

- ​    格式化数据的提示,这里选择 `Yes,dicard any data`

![1537684855707](img\1537684855707.png)

- ​	修改主机域名,这里可以根据自己的喜好进行修改,但不要有中文和特殊字符

![1537685174094](img\1537685174094.png)

- ​	设置网络

![1537686550817](img\1537685174093.png)

- ​	对网络进行设置为开机启动

![1537686689609](img\1537686689609.png)

![1537686887422](img\1537686887422.png)

- ​	选择时区为上海

![1537687013834](img\1537687013834.png)

- ​	设置超级账号Root的密码

![1537687164488](img\1537687164488.png)

> ​	如果密码过于简单,会有提示.但是如果不是正式环境就直接点击 `Use Anyway`
>
> ![1537687323651](img\1537687323651.png)

- ​	给系统进行分盘

![1537687787218](img\1537687787218.png)
...
- ​	磁盘进行分区
  ...
  ![](img\1537689460383.png)

- 给Boot进行分区

![1537690186234](img\1537689537733.png)

![1537690206873](img\1537689962495.png)

- ​	给 / 分配空间

![1537690120712](img\1537690120712.png)

![1537690186234](img\1537689537733.png)

![1537690585319](img\1537690423065.png)

- ​	给swap分配空间

![1537690559965](img\1537690559965.png)

![1537690186234](img\1537689537733.png)

![1537690735631](img\1537690735631.png)

- ​	给/usr分配空间

![1537690960410](img\1537690960410.png)

![1537690186234](img\1537689537733.png)

![1537691051280](img\1537691051280.png)

- ​	给/var分配空间

![1537691135065](img\1537691135065.png)

![1537690186234](img\1537689537733.png)

![1537691240372](img\1537691240372.png)

- ​	给/home分配空间

![1537691314891](img\1537691314891.png)

![1537690186234](img\1537689537733.png)

![1537691431985](img\1537691431985.png)

- ​	分区后的结果

![1537691485426](img\1537691485426.png)

- ​	重新启动系统

![1537692219259](img\1537692219259.png)

- ​	分区后,需要进行分区的格式化

![1537692286196](img\1537692286196.png)

![1537692371682](img\1537692371682.png)

- ​	格式化完毕,下一步

![1537692442923](img\1537692442923.png)

- ​	此次我们安装迷你桌面版(这个版要比桌面版预装的软件少)

![1537692585542](img\1537692585542.png)
...
![1537693237295](img\1537693237295.png)
